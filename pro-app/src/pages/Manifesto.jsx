      ...
      <div className="space-y-8 font-serif text-lg leading-relaxed text-justify opacity-90 pb-20">
        ...
        <div className="space-y-6">
          ...
          <ul className="list-disc pl-8 space-y-4">
            ...
            <li><strong>Saberes Compartilhados:</strong> O projeto materializa as "redes de aprendizagem" facilitando o intercâmbio de habilidades e o acesso a recursos sem a necessidade de mediação institucional burocrática.</li>
            <li><strong>Práxis:</strong> A educação é compreendida como prática social. A plataforma não é neutra; ela serve ao propósito de instrumentalizar o sujeito para a compreensão e transformação das estruturas de opressão.</li>
